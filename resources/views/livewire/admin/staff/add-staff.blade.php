        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="section  custom-row pt-2  px-5    justify-content-between" style="padding-bottom: 60px;">
                    <form action=" {{ route('admin.staff.add-staff') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row ">
                        ...
                        <div class="row ">
                            <div class=" col ">
                                <x-input-select name='type' title='جۆری ستاف' isValid='true' />
                            </div>
                        ...
                        <div class="row ">
                            ...
                            <div class=" col ">
                                <x-input-select-academic_level name="academic_level_id" title="دیاریبکە"
                                    :options="$this->academic_level" />
                            </div>
                            <div class=" col ">
