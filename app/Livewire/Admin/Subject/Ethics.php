...
class Ethics extends Component
{
    ...
    public function boot(){
        $this->users = [
            ['id' => 1, 'subject' => 'babat1', 'nusar' => 'shkar',  'warger' => 'warger1', 'type' => 'پەروەردە','start_date'=>'2024-01-01','end_date'=>'2024-01-10'],
            ...
            ['id' => 5, 'subject' => 'babat1', 'nusar' => 'bilal',  'warger' => 'warger1', 'type' => 'ئەخلاق','start_date'=>'2024-01-01','end_date'=>'2024-01-10'],
            ['id' => 6, 'subject' => 'babat4', 'nusar' => 'shkar',  'warger' => 'warger2', 'type' => 'فێربوون','start_date'=>'2024-01-01','end_date'=>'2024-01-10'],
            ['id' => 7, 'subject' => 'babat2', 'nusar' => 'miran',  'warger' => 'warger2', 'type' => 'پەروەردە','start_date'=>'2024-01-01','end_date'=>'2024-01-10'],
            ['id' => 8, 'subject' => 'babat3', 'nusar' => 'ara',    'warger' => 'warger4', 'type' => 'ئەخلاق','start_date'=>'2024-01-10','end_date'=>'2024-01-20'],
            ['id' => 9, 'subject' => 'babat5', 'nusar' => 'sirwan', 'warger' => 'warger2', 'type' => 'پەروەردە','start_date'=>'2024-01-10','end_date'=>'2024-01-20'],
            ...
            ['id' => 12,'subject' => 'babat1', 'nusar' => 'hardy',  'warger' => 'warger4', 'type' => 'ئەخلاق','start_date'=>'2024-01-10','end_date'=>'2024-01-20'],
        ];
